      ...
      <header className="mb-12 border-b border-white/10 pb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="glass-panel px-4 py-2 font-mono text-xs text-white hover:text-accent hover:border-accent/40 flex items-center gap-2 transition-all duration-200 shadow-md group"
            title="Inspect on-chain curations storage on TzKT Explorer"
          >
            <svg
              className="w-3.5 h-3.5 text-accent group-hover:scale-110 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <span>View Verdicts on Explorer</span>
          </a>
